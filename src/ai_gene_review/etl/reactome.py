...
class ReactomePathway:
    ...
    def to_markdown(self) -> str:
        ...
        body_parts.append(f"**Reactome ID:** [{self.stable_id}](https://reactome.org/content/detail/{self.stable_id})\n")
...
def get_cached_title(reactome_id: str, cache_dir: Path = Path("reactome")) -> Optional[str]:
...
def fetch_reactome_data(reactome_id: str, use_cache: bool = True, cache_dir: Path = Path("reactome")) -> Optional[ReactomePathway]:
    ...
    try:
        ...
        if 'summation' in data and isinstance(data['summation'], list) and data['summation']:
