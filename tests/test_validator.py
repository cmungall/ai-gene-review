...
def test_validate_valid_file():
    ...
    if yaml_file.exists():
        ...
        assert report.is_valid, f"Valid file should pass validation, but got errors: {report.issues}"
...
def test_validate_multiple_files():
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='_invalid.yaml', delete=False) as f:
        invalid_data = {
            "id": "Q456",
            # Missing gene_symbol
        }
...
@pytest.mark.parametrize("gene_data,should_be_valid", [
