...
from ai_gene_review.validation import TermValidator, validate_gene_review, ValidationSeverity
        ...
        "core_functions": [
            {
                "substrates": [
                    {
                        "id": "CFAP300:DNAAF2_complex",
                        "label": "CFAP300-DNAAF2 complex"
                    },
                    {
        ...
        "core_functions": [
            {
                ...
                "substrates": [
                    {
                        "id": "MADEUP:complex_123",
                        "label": "Made-up complex"
                    }
                ]
            }
        ],
